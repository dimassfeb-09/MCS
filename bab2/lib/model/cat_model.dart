class CatModel {
  ...
  CatModel({required this.urlImage, required this.name, required this.desc});

  static List<CatModel> cats = [
    CatModel(
      urlImage:
      ...
      name: "Persia",
      desc: '''Persia merupakan jenis kucing dengan bulu panjang yang
...
dalam ruangan.''',
    ...
    CatModel(
      ...
      name: "Ragdoll",
      desc: '''Ragdoll merupakan kucing besar dengan bulu panjang
...
mirip dengan boneka ragdoll, dan sangat penyayang.''',
    ...
    CatModel(
      ...
      name: "Siam",
      desc: '''Siam merupakan kucing dengan bulu pendek, mata biru
tajam, dan tubuh yang ramping. Mereka dikenal sebagai kucing vokal
yang suka berbicara dan memiliki kepribadian yang aktif serta ramah.''',
    ),
    CatModel(
      urlImage:
      ...
      name: "Sphynx",
      desc: '''Sphynx merupakan jenis kucing tanpa bulu yang memiliki
...
mereka.''',
    ...
    CatModel(
      ...
      name: "Maine Coon",
      desc: '''Maine Coon merupakan salah satu kucing terbesar dengan
bulu panjang dan ekor berbulu tebal. Mereka memiliki sifat yang
ramah, lembut, dan cenderung energik, serta memiliki fisik yang kuat.''',
    ),
    CatModel(
      urlImage:
      ...
      name: "Munchkin",
      desc: '''Munchkin merupakan jenis kucing dengan tubuh pendek
...
penampilan unik yang lucu dan aktif dalam bermain.''',
    ...
    CatModel(
      ...
      name: "Bengal",
      desc: '''Bengal memiliki bulu yang berkilau dengan motif belang
...
sering kali memiliki energi yang tinggi.''',
    ...
    CatModel(
      ...
      desc: '''British Shorthair memiliki penampilan gemuk dengan
